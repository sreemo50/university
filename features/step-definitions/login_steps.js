...
import epaypage from 'E:/newProject/Page_Objects/epaypage'
Given(/^I am on epay.mgu.ac.in"$/,epaypage.launchthepage)
...
//     this.When(/^I click on CERTIFICATE menu$/, function() {
//         //return 
//         console.log("******************************I click on CERTIFICATE menu***********************");
//     });
 
//     this.Then(/^I should see Purpose List$/, function() {       
//         console.log("******************************I should see Purpose List***********************");
//         //return helpers.loadPage(page.duckDuckGoSearch.url, 10)    
//         });
// };
